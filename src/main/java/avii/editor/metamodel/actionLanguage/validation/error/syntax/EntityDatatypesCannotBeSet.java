...
public class EntityDatatypesCannotBeSet extends BaseActionLanguageValidationError {
	...
	public EntityDatatypesCannotBeSet(IEntityDatatype datatype1, IEntityDatatype datatype2, IActionLanguageSyntax lineSyntax, int lineNumber) {
	...
	{
		return "line : " + _lineNumber + " -> '" + _lineSyntax + "' - Datatype " + _datatype1.getClass().getName() + " cannot be set to " + _datatype2 ;
	}
