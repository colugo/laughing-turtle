...
public class Renamable_GenerateEventParamsToClassCreator extends BaseRenamableActionLanguage {
	private Syntax_GenerateEventParamsToClassCreator _syntax = null;
	
	public void setOriginalSyntax(IActionLanguageSyntax syntax) {
		this._syntax = (Syntax_GenerateEventParamsToClassCreator) syntax;
	}
