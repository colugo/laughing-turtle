...
public class Renamable_GenerateEventParamsToInstanceDelayDuration extends BaseRenamableActionLanguage {
	private Syntax_GenerateEventParamsToInstanceDelayDuration _syntax = null;
	
	public void setOriginalSyntax(IActionLanguageSyntax syntax) {
		this._syntax = (Syntax_GenerateEventParamsToInstanceDelayDuration) syntax;
	}
