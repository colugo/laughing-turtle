...
public class Renamable_RelateInstance1ToInstance2AcrossRelationCreatingInstance3 extends BaseRenamableActionLanguage {
	Syntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3 _syntax;
	
	public void setOriginalSyntax(IActionLanguageSyntax syntax) {
		this._syntax = (Syntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3) syntax;
	}
