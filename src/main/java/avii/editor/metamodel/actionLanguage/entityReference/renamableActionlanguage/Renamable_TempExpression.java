...
public class Renamable_TempExpression extends BaseRenamableActionLanguage {
	private Syntax_TempExpression _syntax;
	
	public void setOriginalSyntax(IActionLanguageSyntax syntax) {
		this._syntax = (Syntax_TempExpression) syntax;
	}
