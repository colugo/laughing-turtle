...
public class Syntax_GenerateEventParamsToClassCreator implements IGenerateActionLanguageSyntax, IVisitableActionLanguage {
	...
	public boolean matchesLine(String line) {
		if (line.matches(regex)) {
			...
			_Class = m.group(m.groupCount());
			try {
				enumerateEventParameters(line, _eventName, _Class + " CREATOR");
			} catch (Exception e) {
				return false;
			}
			return true;
