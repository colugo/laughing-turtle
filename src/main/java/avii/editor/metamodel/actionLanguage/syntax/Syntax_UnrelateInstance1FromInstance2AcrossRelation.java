...
public class Syntax_UnrelateInstance1FromInstance2AcrossRelation implements IVisitableActionLanguage {
	...
	public String toString() {
		return "UNRELATE " + _Instance1 + " FROM " + _Instance2 + " ACROSS " + _Relation + ";";
	}
