...
public class DivisionArithmeticOperator extends BaseLogicArithmeticParentNode implements IMultiplyDivideOperatorToken, ILogicParentNode {
	String regex = "^(\\/|\\\\)"; // either divide slash will do
