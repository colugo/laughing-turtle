...
public class Syntax_SelectOneInstance1ThatRelatesInstance2ToInstance3AcrossRelation implements IInstanceCreateAssociationActionLanguage,
	...
	public String toString() {
		return "SELECT ONE " + _Instance1 + " THAT RELATES " + _Instance2 + " TO " + _Instance3 + " ACROSS " + _Relation + ";";
	}
