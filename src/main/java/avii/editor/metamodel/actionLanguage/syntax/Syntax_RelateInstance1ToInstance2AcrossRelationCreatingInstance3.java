...
public class Syntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3 implements IInstanceCreateAssociationActionLanguage, IVisitableActionLanguage {
	...
	private static final String regex = "RELATE " + //
			...
			ActionLanguageSyntaxHelper.GenericName + //
			" ACROSS " + //
			ActionLanguageSyntaxHelper.RelationName + //
			" CREATING " + //
			ActionLanguageSyntaxHelper.GenericName + //
	...
	public IActionLanguageSyntax populateSyntax(String line) {
		...
		_Relation = m.group(3);
		_Instance3 = m.group(4);
		return this;
	}

	@Override
	public String toString() {
		return "RELATE " + _Instance1 + " TO " + _Instance2 + " ACROSS " + _Relation + " CREATING " + _Instance3 + ";";
	}
