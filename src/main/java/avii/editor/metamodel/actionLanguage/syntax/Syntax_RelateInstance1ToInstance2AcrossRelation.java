...
public class Syntax_RelateInstance1ToInstance2AcrossRelation implements IVisitableActionLanguage {
	...
	public String toString() {
		return "RELATE " + _Instance1 + " TO " + _Instance2 + " ACROSS " + _Relation + ";";
	}
