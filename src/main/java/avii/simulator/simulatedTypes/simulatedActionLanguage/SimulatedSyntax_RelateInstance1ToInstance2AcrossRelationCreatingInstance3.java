...
public class SimulatedSyntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3 extends BaseSimulatedActionLanguage implements IRelationAlteringSyntax {

	private Syntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3 _specificSyntax;

	public SimulatedSyntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3(Simulator theSimulator, IActionLanguageSyntax theConcreteSyntax) {
		super(theSimulator, theConcreteSyntax);
		this._specificSyntax = (Syntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3) theConcreteSyntax;
	}

	public SimulatedSyntax_RelateInstance1ToInstance2AcrossRelationCreatingInstance3() {
	}
