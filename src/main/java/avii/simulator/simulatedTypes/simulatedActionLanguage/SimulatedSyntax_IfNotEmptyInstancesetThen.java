...
public class SimulatedSyntax_IfNotEmptyInstancesetThen extends BaseSimulatedActionLanguage {

	private Syntax_IfNotEmptyInstancesetThen _specificSyntax;
	private boolean _wasIfTrue;

	public SimulatedSyntax_IfNotEmptyInstancesetThen(Simulator theSimulator, IActionLanguageSyntax theConcreteSyntax) {
		super(theSimulator, theConcreteSyntax);
		this._specificSyntax = (Syntax_IfNotEmptyInstancesetThen)theConcreteSyntax;
	}

	public SimulatedSyntax_IfNotEmptyInstancesetThen() {
	}
